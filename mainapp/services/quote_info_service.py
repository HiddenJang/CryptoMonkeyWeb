...
class QuoteInfo:
    """Класс получения данных с сайтов криптоплощадок и взаимодействия с базой данных.
    ...
    @staticmethod
    async def _get_kucoin_data(session, base_coin):
        # url = 'https://api.kucoin.com/api/v1/market/orderbook/level1?symbol=BTC-USDT'
        url = f'https://api.kucoin.com/api/v1/prices?base={base_coin}'
        headers = {
    ...
    async def get_coins_data(self, settings: dict) -> list:
