    ...
    def registrate_user(self) -> dict:
        ...
        if self.request.method == 'POST':
            ...
            if not user_login or not user_password or not first_name or not email:
                ...
                return {'result': False, 'page': 'registration_page.html', 'context': context}
            try:
            ...
            return {'result': False, 'page': 'registration_page.html', 'context': {}}

    def login_user(self) -> dict:
        """Авторизация пользователя"""

        if self.request.user.is_authenticated:
            return {'result': True, 'page': 'app_mainpage', 'context': {}}
