"""
Django settings for CryptoMonkeyWeb project.
...
SECRET_KEY = 'django-insecure-)-(kwwucw^io2*$#*iktm9t7bvc3*)x!0pm6%kj$j8z86wlt=('
...
ROOT_URLCONF = 'CryptoMonkeyWeb.urls'
...
WSGI_APPLICATION = 'CryptoMonkeyWeb.wsgi.application'
